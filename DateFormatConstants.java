...
public interface DateFormatConstants {
	...
	public static final String DATE_FORMAT_MM_DD_YYYY = "MM-dd-yyyy HH:mm:ss a";
	public static final String DATE_FORMAT_YYYY_MM_DD = "yyyy-MM-dd";
	public static final String DATE_FORMAT_YYYY_MM_DD_HH_MM = "yyyy-MM-dd HH:mm:ss";
	public static final String DATE_FORMAT_DD_MM_YYYY = "dd-MM-yyyy HH:mm:ss a";
	public static final String DATE_FORMAT_DD_MM_YYYY_T_HH_MM_SS = "dd-MM-yyyy'T'HH:mm:ss";
